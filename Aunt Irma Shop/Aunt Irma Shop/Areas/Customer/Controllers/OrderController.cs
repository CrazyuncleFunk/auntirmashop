...
namespace Aunt_Irma_Shop.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> ManageOrder()
        {
            ...
            List<OrderHeader> OrderHeaderList = await _db.OrderHeader.Where(u => u.Status == SD.StatusSubmitted || u.Status == SD.StatusInProcess).OrderByDescending(o => o.PickUpTime).ToListAsync();
        ...
        public async Task<IActionResult> GetOrderDetails(int Id)
        {
            ...
            return PartialView("_InduvidualOrderDetails", orderDetailsViewModel);
        }
        public async Task<IActionResult> GetOrderStatus(int Id)
        {
            var orderHeader = await _db.OrderHeader.FirstOrDefaultAsync(m => m.Id == Id);
